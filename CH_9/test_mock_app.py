...
from myapp import get_orders_by_customer


class TestApp(unittest.TestCase):
    cookie_orders = [(1, u'cookiemon', u'111-111-1111')]
    cookie_details = [(1, u'cookiemon', u'111-111-1111',
                       u'dark chocolate chip', 2, Decimal('1.00')),
                      (1, u'cookiemon', u'111-111-1111', u'oatmeal raisin', 12,
                       Decimal('3.00'))]
    #patching the mock into the session
    @mock.patch('app.dal.session')
    #passing the mock into the function
    def test_orders_by_customer_blank(self, mock_dal):
        #query runs on the mock
